...
```
cd existing_repo
git remote add origin https://github.com/osvax/gulp-for-lesson.git
git branch -M main
...
* [Set up project integrations](https://github.com/osvax/gulp-for-lesson/-/settings/integrations)
